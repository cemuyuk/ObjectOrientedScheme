...
(define (populate-weapons rooms)
  ...
  (create-weapon 'wmine1 (pick-random rooms) 4)
  (create-weapon 'wmine2 (pick-random rooms) 4)
  (create-weapon 'wmine3 (pick-random rooms) 4)
  (create-weapon 'wmine4 (pick-random rooms) 4)
  (create-weapon 'wmine5 (pick-random rooms) 4)
  (create-weapon 'wmine6 (pick-random rooms) 4)
  (create-weapon 'wmine7 (pick-random rooms) 4)
  (create-weapon 'wmine8 (pick-random rooms) 4)
  (create-weapon 'wmine9 (pick-random rooms) 4)
  (create-weapon 'wmine10 (pick-random rooms) 4)
  (create-weapon 'wmine11 (pick-random rooms) 4)
  (create-weapon 'wmine12 (pick-random rooms) 4)
  (create-weapon 'wmine13 (pick-random rooms) 4)
  (create-weapon 'wmine14 (pick-random rooms) 4)
  (create-weapon 'wmine15 (pick-random rooms) 4)
  (create-weapon 'wmine16 (pick-random rooms) 4)
  (create-weapon 'wmine17 (pick-random rooms) 4)
  (create-weapon 'wmine18 (pick-random rooms) 4)
...
(define (populate-bombs rooms)  	    	  	  
  ...
  (create-bomb 'mbomb1 (pick-random rooms) 2)
  (create-bomb 'mbomb2 (pick-random rooms) 5)
  (create-bomb 'mbomb3 (pick-random rooms) 10)
  (create-bomb 'mbomb4 (pick-random rooms) 4)
  (create-bomb 'mbomb5 (pick-random rooms) 7)
  (create-bomb 'mbomb6 (pick-random rooms) 2)
  (create-bomb 'mbomb7 (pick-random rooms) 5)
  (create-bomb 'mbomb8 (pick-random rooms) 10)
  (create-bomb 'mbomb9 (pick-random rooms) 4)
  (create-bomb 'mbomb10 (pick-random rooms) 7)
  ...
  (create-bomb-with-timer 'tBomb7 (pick-random rooms) 10)
  (create-bomb-with-timer 'tBomb8 (pick-random rooms) 10)
  (create-bomb-with-timer 'tBomb9 (pick-random rooms) 10)
  (create-bomb-with-timer 'tBomb10 (pick-random rooms) 10)
  (create-bomb-with-timer 'tBomb11 (pick-random rooms) 10)
  'populated-bombs)

(define (populate-violent-people rooms)
  (create-violent-person 'violent1 (pick-random rooms) 3 3 1)
  (create-violent-person 'violent2 (pick-random rooms) 3 2 1)
  (create-violent-person 'violent3 (pick-random rooms) 3 4 1)
  (create-violent-person 'violent4 (pick-random rooms) 2 3 1)
  (create-violent-person 'violent5 (pick-random rooms) 5 6 1)
  (create-violent-person 'violent6 (pick-random rooms) 6 7 1)
